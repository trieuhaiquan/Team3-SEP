...
$objWriter->setIncludeCharts(TRUE);
 ...
 if(!is_dir('export/'))
                        ...
                        $full_path =  'export/'.date('y-m-d-h-i').'.export.xlsx';//duong dan file
                        $objWriter->save($full_path);
                        ?>
<div class="col-lg-12">
  <a href="<?=BASE_URL ?>export/<?php echo date('y-m-d-h-i')?>.export.xlsx" class="btn btn-dropbox" style="background-color: red; color:white; float: left;margin-bottom: 10px;box-sizing: border-box;" >Download File </a>
